...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <%@include file="../include/header.jsp" %> 
          ...
          </c:if>  <!-- 유저가 null 값이 아니면 트루 로그인하면 null 값이 아니니 보여짐 -->
  ...
  <div class="content-wrapper">
    ...
    <div class="box-header wuth-border">      <!--  밑에 c:if 는 jstl 문법 -->
     <c:if test="${user == null }"> 
    ...
    <label>제목</label> <input type="text" name='title' class="form-control"  placeholder="제목을 입력하세요">    
    </div>
    <div class="form-group"> <label>내용</label>  <textarea class="form-control" name="content" rows="3" placeholder="내용을 입력하세요"></textarea></div>
    <div class="form-group ">
    <label> 작성자</label> <input type="text" name="id" class="form-control" value="${user.name }" readonly>
    </div>
