...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <a href="/board/logout"> <h3 class="box-title"> 로그 아웃 </h3></a><br> <hr>
    <a href="/board/register"> 글 작성</a></td>
    </c:if>   
    </div>
    ...
    <tr>
    <td> <a href="/board/custom2?bno=${board.bno }">${board.bno }</a></td>
    <td>${board.title }</td>
    <td>${board.content }</td>
    <td>${board.id}</td>
    <td>${board.reddate }</td>
    <td><sapn class="badge">${board.readcnt }</td>
