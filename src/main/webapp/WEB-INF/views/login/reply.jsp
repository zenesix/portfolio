...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <label>작성자</label>
   <input type="text" name="rewriter" value="${user.name}" class="form-control" placeholder="댓글을 입력하세요"> 
   <textarea class="form-control" name="rememo" rows="3" placeholder="댓글을 입력하세요"> </textarea>
